...
plugin_path = resolveFilename(SCOPE_PLUGINS, "Extensions/{}".format('MagicapanelGold'))
...
class Console(Screen):
	...
	def __init__(self, session, title='MagicapanelGold Console', cmdlist=None, finishedCallback=None, closeOnSuccess=False, showStartStopText=True, skin=None):
		...
		self.newtitle = title == 'MagicapanelGold Console' and ('Console') or title
